...
```yaml
- uses: qwibitai/kubeclaw/repo-tokens@v1
  with:
    include: 'src/**/*.ts'
    exclude: 'src/**/*.test.ts'
```
...
| Repo | Badge |
|------|-------|
| [KubeClaw](https://github.com/qwibitai/KubeClaw) | ![tokens](https://raw.githubusercontent.com/qwibitai/KubeClaw/main/repo-tokens/badge.svg) |
