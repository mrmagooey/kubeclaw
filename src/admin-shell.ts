      ...
      parameters: {
        ...
        properties: {
          name: {
            type: 'string',
            description:
              'Tool name the LLM calls (letters, digits, hyphens, underscores; must start with a letter). Must not collide with a built-in (places_search) or a built-in category (execution, places).',
          },
          description: {
            type: 'string',
